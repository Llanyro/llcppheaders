...
template <class Node_Type_Or_Functions, ll_bool_t IS_SPECIAL = LL_FALSE> class NodePrev : private Node<Node_Type_Or_Functions, IS_SPECIAL> {
...
}; template<class NodeType> using SimplePrev = NodePrev<NodeType, LL_FALSE>; template<class NodeFunctions> using FunctionalPrev = NodePrev<NodeFunctions, LL_FALSE>;

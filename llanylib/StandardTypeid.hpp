...
__LL_VAR_INLINE__ constexpr meta::StrTypeid FAST_TYPEID_UI8 = meta::STANDARD_TYPEID<ui8>();
__LL_VAR_INLINE__ constexpr meta::StrTypeid FAST_TYPEID_UI16 = meta::STANDARD_TYPEID<ui16>();
__LL_VAR_INLINE__ constexpr meta::StrTypeid FAST_TYPEID_UI32 = meta::STANDARD_TYPEID<ui32>();
__LL_VAR_INLINE__ constexpr meta::StrTypeid FAST_TYPEID_UI64 = meta::STANDARD_TYPEID<ui64>();
__LL_VAR_INLINE__ constexpr meta::StrTypeid FAST_TYPEID_I8 = meta::STANDARD_TYPEID<i8>();
__LL_VAR_INLINE__ constexpr meta::StrTypeid FAST_TYPEID_I16 = meta::STANDARD_TYPEID<i16>();
__LL_VAR_INLINE__ constexpr meta::StrTypeid FAST_TYPEID_I32 = meta::STANDARD_TYPEID<i32>();
__LL_VAR_INLINE__ constexpr meta::StrTypeid FAST_TYPEID_I64 = meta::STANDARD_TYPEID<i64>();
__LL_VAR_INLINE__ constexpr meta::StrTypeid FAST_TYPEID_F32 = meta::STANDARD_TYPEID<f32>();
__LL_VAR_INLINE__ constexpr meta::StrTypeid FAST_TYPEID_F64 = meta::STANDARD_TYPEID<f64>();
__LL_VAR_INLINE__ constexpr meta::StrTypeid FAST_TYPEID_F128 = meta::STANDARD_TYPEID<f128>();
__LL_VAR_INLINE__ constexpr meta::StrTypeid FAST_TYPEID_HASH32 = meta::STANDARD_TYPEID<hash::Hash32>();
__LL_VAR_INLINE__ constexpr meta::StrTypeid FAST_TYPEID_HASH64 = meta::STANDARD_TYPEID<hash::Hash64>();
__LL_VAR_INLINE__ constexpr meta::StrTypeid FAST_TYPEID_HASH128 = meta::STANDARD_TYPEID<hash::Hash128>();
__LL_VAR_INLINE__ constexpr meta::StrTypeid FAST_TYPEID_STRTYPEID = meta::STANDARD_TYPEID<StrTypeid>();
__LL_VAR_INLINE__ constexpr meta::StrTypeid FAST_TYPEID_WSTRTYPEID = meta::STANDARD_TYPEID<wStrTypeid>();

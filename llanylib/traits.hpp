...
struct has_hash_function {
	...
	template<class _U>
	static constexpr auto test(checker<&_U::hash>*) noexcept	-> std::true_type;
	template<class _U> static constexpr auto test(...) noexcept	-> std::false_type;
};
template<class ClassToCheck, class Signature>
using has_hash_function_t =
	traits::_has_common<traits::common::has_hash_function<ClassToCheck, Signature>>;
template<class ClassToCheck, class Signature>
__LL_VAR_INLINE__ constexpr ll_bool_t has_hash_function_v = 
	traits::common::has_hash_function_t<ClassToCheck, Signature>::type::value;
...
struct has_clear_function {
	...
	template<class _U>
	static constexpr auto test(checker<&_U::clear>*) noexcept	-> std::true_type;
	template<class _U> static constexpr auto test(...) noexcept	-> std::false_type;
};
template<class ClassToCheck, class Signature>
using has_clear_function_t =
	traits::_has_common<traits::common::has_clear_function<ClassToCheck, Signature>>;
template<class ClassToCheck, class Signature>
__LL_VAR_INLINE__ constexpr ll_bool_t has_clear_function_v = 
	traits::common::has_clear_function_t<ClassToCheck, Signature>::type::value;

#pragma endregion
#pragma region Swap
template<class _ClassToCheck, class _Signature>
struct has_swap_function {
	using _MyType		= has_swap_function;
	using ClassToCheck	= _ClassToCheck;
	using Signature		= _Signature;
	template<Signature SIG>
	using checker		= traits::SignatureChecker<ClassToCheck, Signature, SIG>;
	...
	template<class _U>
	static constexpr auto test(checker<&_U::swap>*) noexcept	-> std::true_type;
	template<class _U> static constexpr auto test(...) noexcept	-> std::false_type;
};
template<class ClassToCheck, class Signature>
using has_swap_function_t =
	traits::_has_common<traits::common::has_swap_function<ClassToCheck, Signature>>;
template<class ClassToCheck, class Signature>
...
struct has_copy_function {
	...
	template<class _U>
	static constexpr auto test(checker<&_U::copy>*) noexcept	-> std::true_type;
	template<class _U> static constexpr auto test(...) noexcept	-> std::false_type;
};
template<class ClassToCheck, class Signature>
using has_copy_function_t =
	traits::_has_common<traits::common::has_copy_function<ClassToCheck, Signature>>;
template<class ClassToCheck, class Signature>

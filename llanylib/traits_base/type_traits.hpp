...
template<class T>
class HasIteratorType<T, ::std::void_t<typename T::iterator_type>> : public ::std::true_type {};

template<class T>
__LL_VAR_INLINE__ constexpr ll_bool_t has_iterator_type_v = ::llcpp::meta::traits::HasIteratorType<T>::value;

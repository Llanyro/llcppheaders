...
constexpr auto make_constructed_array(const Args&... args, std::index_sequence<Idx...>) -> U {
	return U((Idx, T(args...))...);
}
template<class T, class... Args, len_t... Idx>
constexpr auto make_constructed_new_mem(T* mem, const Args&... args, std::index_sequence<Idx...>) -> T* {
...
template<class U, class T, len_t N, T NULL_ITEM, class... Args>
constexpr U make_constructed_array(const Args&... args) {
...
constexpr auto make_constructed_new_mem(T* mem, const Args&... args) -> T* {

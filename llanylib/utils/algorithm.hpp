...
#include <array>	// Contains <utility>
...
class CompareDefault {
	...
	public:
		...
		using IsDifferenciable	= traits::IsDifferenciable<T, U>;
		using IsComparable		= traits::IsComparable<T, U>;

	#pragma endregion
	#pragma region Assert
	public:
		static_assert(IsDifferenciable::IS_C_COMPARABLE,
			"Types are not differenciables!");
		static_assert(IsComparable::IS_COMPARABLE_EQ,
	...
	public:
		__LL_NODISCARD__ constexpr c_cmp_t compare(t_cinput t, u_cinput u) const noexcept {
			return IsDifferenciable().c_diff(t, u);
		}
		__LL_NODISCARD__ constexpr ll_bool_t compareBool(t_cinput t, u_cinput u) const noexcept {
			return IsComparable().is_same_value(t, u);
		}
...
class ComparatorChecker : public _Comparator {
	...
	public:
		...
		// Signarures
		using CompareSignature		= c_cmp_t(Comparator::*)(cinput_t, cinput_u) const noexcept;
	...
	public:
		...
		static_assert(std::is_class_v<Comparator>,
			"Comparator must be a class type!");
		static_assert(traits::is_valid_constructor_checker_v<Comparator>,
...
using CompareConditional = traits::conditional_t<GET_DATA, algorithm::CompareData<T, U, result_t, NULL_RESULT>, result_t>;
template<class T, class U, ll_bool_t GET_DATA>
using CompareConditionalCmpT = algorithm::CompareConditional<T, U, c_cmp_t, ZERO_CMP, GET_DATA>;
template<class T, class U, ll_bool_t GET_DATA>
...
class CompareCluster : public algorithm::__algorithm__::ComparatorChecker<_T, _U, _Comparator> {
	...
	public:
		...
		using Comparator		= _Comparator;
		using ComparatorChecker	= algorithm::__algorithm__::ComparatorChecker<_T, _U, _Comparator>;
		...
		using ConstArray_t		= meta::ConstArray<T>;
		using ConstArray_u		= meta::ConstArray<U>;
		using Array_t			= meta::Array<T>;
		using Array_u			= meta::Array<U>;

		template<u64 N>
		using STDArray_t		= std::array<T, N>;
		template<u64 N>
		using STDArray_u		= std::array<U, N>;
	...
	public:
		__LL_NODISCARD__ constexpr c_cmp_t compare(cinput_t a, cinput_u b) const noexcept {
	...
	public:
		__LL_NODISCARD__ constexpr CompareResult compare(const T* _array1, const U* _array2, u64 size) const noexcept {
			CompareResult res;
			...
			for (; size > llcpp::ZERO_UI64; --size, ++_array1, ++_array2) {
				c_cmp_t result = this->compare(*_array1, *_array2);
		...
		__LL_NODISCARD__ constexpr CompareResultBool compareBool(const T* _array1, const U* _array2, u64 size) const noexcept {
			CompareResultBool res;
		...
		#pragma region Ptr
	public:
		__LL_NODISCARD__ constexpr CompareResultBool equals(const T* _array1, const u64 size1, const U* _array2, const u64 size2) const noexcept {
		...
		__LL_NODISCARD__ constexpr CompareResultBool equals(const T* _array1, const u64 size1, const ConstArray_u& _array2) const noexcept {
			return this->equals(_array1, size1, _array2.begin(), _array2.size());
		}
		__LL_NODISCARD__ constexpr CompareResultBool equals(const T* _array1, const u64 size1, const Array_u& _array2) const noexcept {
			return this->equals(_array1, size1, _array2.begin(), _array2.size());
		}
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool equals(const T* _array1, const u64 size1, const STDArray_u<N>& _array2) const noexcept {
			return this->equals(_array1, size1, _array2.begin(), _array2.size());
		}
	...
	public:
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool equals(const T(&_array1)[N], const U* _array2, const u64 size2) const noexcept {
			return this->equals(_array1, N, _array2, size2);
		}
		template<u64 N, u64 N2>
		...
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool equals(const T(&_array1)[N], const ConstArray_u& _array2) const noexcept {
		...
		template<u64 N2, u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool equals(const T(&_array1)[N], const STDArray_u<N2>& _array2) const noexcept {
			return this->equals(_array1, N, _array2.begin(), _array2.size());
		}
	...
	public:
		__LL_NODISCARD__ constexpr CompareResultBool equals(const ConstArray_t& _array1, const U* _array2, const u64 size2) const noexcept {
			return this->equals(_array1.begin(), _array1.size(), _array2, size2);
		}
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool equals(const ConstArray_t& _array1, const U(&_array2)[N]) const noexcept {
			return this->equals(_array1.begin(), _array1.size(), _array2, N);
		}
		__LL_NODISCARD__ constexpr CompareResultBool equals(const ConstArray_t& _array1, const ConstArray_u& _array2) const noexcept {
			return this->equals(_array1.begin(), _array1.size(), _array2.begin(), _array2.size());
		}
		__LL_NODISCARD__ constexpr CompareResultBool equals(const ConstArray_t& _array1, const Array_u& _array2) const noexcept {
			return this->equals(_array1.begin(), _array1.size(), _array2.begin(), _array2.size());
		}
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool equals(const ConstArray_t& _array1, const STDArray_u<N>& _array2) const noexcept {
			return this->equals(_array1.begin(), _array1.size(), _array2.begin(), _array2.size());
		}
		...
		#pragma region Array
	public:
		__LL_NODISCARD__ constexpr CompareResultBool equals(const Array_t& _array1, const U* _array2, const u64 size2) const noexcept {
			return this->equals(_array1.begin(), _array1.size(), _array2, size2);
		}
		template<u64 N>
		...
		__LL_NODISCARD__ constexpr CompareResultBool equals(const Array_t& _array1, const ConstArray_u& _array2) const noexcept {
			return this->equals(_array1.begin(), _array1.size(), _array2.begin(), _array2.size());
		}
		...
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool equals(const Array_t& _array1, const STDArray_u<N>& _array2) const noexcept {
			return this->equals(_array1.begin(), _array1.size(), _array2.begin(), _array2.size());
		}
	...
	public:
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool equals(const STDArray_t<N>& _array1, const U* _array2, const u64 size2) const noexcept {
			return this->equals(_array1.begin(), _array1.size(), _array2, size2);
		}
		template<u64 N2, u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool equals(const STDArray_t<N2>& _array1, const U(&_array2)[N]) const noexcept {
			return this->equals(_array1.begin(), _array1.size(), _array2, N);
		}
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool equals(const STDArray_t<N>& _array1, const ConstArray_u& _array2) const noexcept {
			return this->equals(_array1.begin(), _array1.size(), _array2.begin(), _array2.size());
		}
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool equals(const STDArray_t<N>& _array1, const Array_u& _array2) const noexcept {
			return this->equals(_array1.begin(), _array1.size(), _array2.begin(), _array2.size());
		}
		template<u64 N, u64 N2>
		__LL_NODISCARD__ constexpr CompareResultBool equals(const STDArray_t<N>& _array1, const STDArray_u<N2>& _array2) const noexcept {
			return this->equals(_array1.begin(), _array1.size(), _array2.begin(), _array2.size());
		}
	...
	public:
		...
		__LL_NODISCARD__ constexpr CompareResultBool startsWithImmpementation(const T* _array, const U* needle, u64 size) const noexcept {
			CompareResultBool res;
		...
		#pragma region Ptr
	public:
		__LL_NODISCARD__ constexpr CompareResultBool startsWith(const T* _array, const u64 size1, const U* needle, const u64 size2) const noexcept {
		...
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool startsWith(const T* _array, const u64 size1, const U(&needle)[N]) const noexcept {
			return this->startsWith(_array, size1, needle, N);
		}
		__LL_NODISCARD__ constexpr CompareResultBool startsWith(const T* _array, const u64 size1, const ConstArray_u& needle) const noexcept {
			return this->startsWith(_array, size1, needle.begin(), needle.size());
		}
		__LL_NODISCARD__ constexpr CompareResultBool startsWith(const T* _array, const u64 size1, const Array_u& needle) const noexcept {
			return this->startsWith(_array, size1, needle.begin(), needle.size());
		}
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool startsWith(const T* _array, const u64 size1, const STDArray_u<N>& needle) const noexcept {
			return this->startsWith(_array, size1, needle.begin(), needle.size());
		}
	...
	public:
		...
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool startsWith(const T(&_array)[N], const U* needle, const u64 size2) const noexcept {
			return this->startsWith(_array, N, needle, size2);
		}
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool startsWith(const T(&_array)[N], const ConstArray_u& needle) const noexcept {
			return this->startsWith(_array, N, needle.begin(), needle.size());
		}
		template<u64 N>
		...
		template<u64 N2, u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool startsWith(const T(&_array)[N], const STDArray_u<N2>& needle) const noexcept {
			return this->startsWith(_array, N, needle.begin(), needle.size());
		}
		...
		#pragma region ConstArray
	public:
		__LL_NODISCARD__ constexpr CompareResultBool startsWith(const ConstArray_t& _array, const U* needle, u64 size) const noexcept {
			return this->startsWith(_array.begin(), _array.size(), needle, size);
		}
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool startsWith(const ConstArray_t& _array, const U(&needle)[N]) const noexcept {
			return this->startsWith(_array.begin(), _array.size(), needle, N);
		}
		__LL_NODISCARD__ constexpr CompareResultBool startsWith(const ConstArray_t& _array, const ConstArray_u& needle) const noexcept {
			return this->startsWith(_array.begin(), _array.size(), needle.begin(), needle.size());
		}
		__LL_NODISCARD__ constexpr CompareResultBool startsWith(const ConstArray_t& _array, const Array_u& needle) const noexcept {
			return this->startsWith(_array.begin(), _array.size(), needle.begin(), needle.size());
		}
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool startsWith(const ConstArray_t& _array, const STDArray_u<N>& needle) const noexcept {
			return this->startsWith(_array.begin(), _array.size(), needle.begin(), needle.size());
		}
		...
		#pragma region Array
	public:
		__LL_NODISCARD__ constexpr CompareResultBool startsWith(const Array_t& _array, const U* needle, u64 size) const noexcept {
			return this->startsWith(_array.begin(), _array.size(), needle, size);
		}
		template<u64 N>
		...
		__LL_NODISCARD__ constexpr CompareResultBool startsWith(const Array_t& _array, const ConstArray_u& needle) const noexcept {
			return this->startsWith(_array.begin(), _array.size(), needle.begin(), needle.size());
		}
		...
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool startsWith(const Array_t& _array, const STDArray_u<N>& needle) const noexcept {
			return this->startsWith(_array.begin(), _array.size(), needle.begin(), needle.size());
		}
		...
		#pragma region Ptr
	public:
		__LL_NODISCARD__ constexpr CompareResultBool endsWith(const T* _array, const u64 size1, const U* needle, const u64 size2) const noexcept {
			if (size1 < size2 || (size1 != size2 && size2 == ZERO_UI64)) return CompareResultBool(llcpp::FALSE);
			else return this->startsWithImmpementation((_array + size1) - size2, needle, size2);
		}
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool endsWith(const T* _array, const u64 size1, const U(&needle)[N]) const noexcept {
			return this->endsWith(_array, size1, needle, N);
		}
		__LL_NODISCARD__ constexpr CompareResultBool endsWith(const T* _array, const u64 size1, const ConstArray_u& needle) const noexcept {
			return this->endsWith(_array, size1, needle.begin(), needle.size());
		}
		__LL_NODISCARD__ constexpr CompareResultBool endsWith(const T* _array, const u64 size1, const Array_u& needle) const noexcept {
			return this->endsWith(_array, size1, needle.begin(), needle.size());
		}
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool endsWith(const T* _array, const u64 size1, const STDArray_u<N>& needle) const noexcept {
			return this->endsWith(_array, size1, needle.begin(), needle.size());
		}
	...
	public:
		...
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool endsWith(const T(&_array)[N], const U* needle, const u64 size2) const noexcept {
			return this->endsWith(_array, N, needle, size2);
		}
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool endsWith(const T(&_array)[N], const ConstArray_u& needle) const noexcept {
			return this->endsWith(_array, N, needle.begin(), needle.size());
		}
		template<u64 N>
		...
		template<u64 N2, u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool endsWith(const T(&_array)[N], const STDArray_u<N>& needle) const noexcept {
			return this->endsWith(_array, N, needle.begin(), needle.size());
		}
		...
		#pragma region ConstArray
	public:
		__LL_NODISCARD__ constexpr CompareResultBool endsWith(const ConstArray_t& _array, const U* needle, u64 size) const noexcept {
			return this->endsWith(_array.begin(), _array.size(), needle, size);
		}
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool endsWith(const ConstArray_t& _array, const U(&needle)[N]) const noexcept {
			return this->endsWith(_array.begin(), _array.size(), needle, N);
		}
		__LL_NODISCARD__ constexpr CompareResultBool endsWith(const ConstArray_t& _array, const ConstArray_u& needle) const noexcept {
			return this->endsWith(_array.begin(), _array.size(), needle.begin(), needle.size());
		}
		__LL_NODISCARD__ constexpr CompareResultBool endsWith(const ConstArray_t& _array, const Array_u& needle) const noexcept {
			return this->endsWith(_array.begin(), _array.size(), needle.begin(), needle.size());
		}
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool endsWith(const ConstArray_t& _array, const STDArray_u<N>& needle) const noexcept {
			return this->endsWith(_array.begin(), _array.size(), needle.begin(), needle.size());
		}
		...
		#pragma region Array
	public:
		__LL_NODISCARD__ constexpr CompareResultBool endsWith(const Array_t& _array, const U* needle, u64 size) const noexcept {
			return this->endsWith(_array.begin(), _array.size(), needle, size);
		}
		template<u64 N>
		...
		__LL_NODISCARD__ constexpr CompareResultBool endsWith(const Array_t& _array, const ConstArray_u& needle) const noexcept {
			return this->endsWith(_array.begin(), _array.size(), needle.begin(), needle.size());
		}
		...
		template<u64 N>
		__LL_NODISCARD__ constexpr CompareResultBool endsWith(const Array_t& _array, const STDArray_u<N>& needle) const noexcept {
			return this->endsWith(_array.begin(), _array.size(), needle.begin(), needle.size());
		}
...
struct FindersCluster : public algorithm::__algorithm__::ComparatorChecker<_T, _U, _Comparator> {
	...
	public:
		...
		using cinput_t			= ComparatorChecker::cinput_t;
		using cinput_u			= ComparatorChecker::cinput_u;
		using FindResult		= traits::conditional_t<POSITION, u64, const T*>;
		using ConstArray_t		= meta::ConstArray<T>;
		using ConstArray_u		= meta::ConstArray<U>;
		using Array_t			= meta::Array<T>;
		using Array_u			= meta::Array<U>;
	...
	public:
		...
		__LL_NODISCARD__ constexpr FindResult find(const ConstArray_t& _array, cinput_u object) const noexcept {
	...
	public:
		...
		__LL_NODISCARD__ constexpr FindResult rfind(const ConstArray_t& _array, cinput_u object) const noexcept {
	...
	public:
		...
		__LL_NODISCARD__ constexpr ll_bool_t contains(const ConstArray_t& _array, cinput_u object) const noexcept {
	...
	public:
		...
		__LL_NODISCARD__ constexpr ll_bool_t all(const ConstArray_t& _array, cinput_u object) const noexcept {
	...
	public:
		...
		__LL_NODISCARD__ constexpr ll_bool_t any(const ConstArray_t& _array, cinput_u object) const noexcept {
		...
		__LL_NODISCARD__ constexpr ll_bool_t none(const ConstArray_t& _array, cinput_u object) noexcept {
		...
		__LL_NODISCARD__ constexpr ll_bool_t none(const ConstArray_t& _array, cinput_u object) const noexcept {
			return this->none(_array.begin(), _array.end(), object);
		}
		...
		//	while (low <= high) {
		//		u64 mid = ((high - low) >> 1);
		//		c_cmp_t res = this->compare(begin[mid], object);
		...
		#pragma region Proxy
		//__LL_NODISCARD__ constexpr u64 binarysearch_pos(const T* begin, const T* end, cinput_u object) noexcept {
		...
		//}
		//template<u64 N>
		//__LL_NODISCARD__ constexpr u64 binarysearch_pos(const T (&data)[N], cinput_u object) noexcept {
		//	if (!data || N == ZERO_UI64) return data + N;
		//	return this->binarysearch_pos(data, data + N, object);
		//}
		//__LL_NODISCARD__ constexpr const T* binarysearch(const ConstArray_t& _array, cinput_u object) noexcept {
		//	return this->binarysearch(_array.begin(), _array.end(), object);
		//}
		//__LL_NODISCARD__ constexpr u64 binarysearch_pos(const ConstArray_t& _array, cinput_u object) noexcept {
...
class DataManipulatorCluster : public _Manipulator {
	...
	public:
		#pragma region Base
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		...
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		...
		template<class U = T, class W = traits::cinput<U>, CopyExtraSignature<W> COPY = meta::common::simple_set<T, W>, u64 N>
		constexpr void fill(T(&dst)[N], W object) const noexcept {
	...
	public:
		#pragma region Base
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void copy(const U* src, T* dst, u64 size, FunctionManipulator&& man) const noexcept {
			using CopyFunction = void(FunctionManipulator::*)(T&, W) const noexcept;
			static_assert(traits::common::has_copy_function_v<FunctionManipulator, CopyFunction>,
				"FunctionManipulator::copy() const noexcept is required!");
		...
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void copy(const U* src, T* dst, u64 size) const noexcept {
			static_assert(std::is_nothrow_constructible_v<FunctionManipulator>, "FunctionManipulator needs a noexcept constructor!");
			static_assert(std::is_nothrow_destructible_v<FunctionManipulator>, "FunctionManipulator needs a noexcept destructor!");
			static_assert(std::is_copy_constructible_v<FunctionManipulator>, "FunctionManipulator needs a noexcept copy constructor!");
			static_assert(std::is_copy_assignable_v<FunctionManipulator>, "FunctionManipulator needs a noexcept copy asignable!");
		...
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr ll_bool_t copy_s(const U* src, T* dst, u64 size, FunctionManipulator&& man) const noexcept {
		...
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr ll_bool_t copy_s(const U* src, T* dst, u64 size) const noexcept {
			if (!src || !dst || size == ZERO_UI64) return llcpp::FALSE;
		...
		#pragma region FunctionManipulatorAsParameter
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void copy(const meta::ConstArray<U>& src, T* dst, const u64 size, FunctionManipulator&& man) const noexcept {
			this->copy<U, W, FunctionManipulator>(src.begin(), dst, math::min<u64>(src.size(), size), std::forward<FunctionManipulator>(man));
		}
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void copy(const meta::ConstArray<U>& src, Array_t& dst, FunctionManipulator&& man) noexcept {
			this->copy<U, W, FunctionManipulator>(src.begin(), dst.begin(), math::min<u64>(src.size(), dst.size()), std::forward<FunctionManipulator>(man));
		}
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		...
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr void copy(const U(&src)[N], T* dst, const u64 size, FunctionManipulator&& man) noexcept {
			this->copy<U, W, FunctionManipulator>(src, dst, math::min<u64>(N, size), std::forward<FunctionManipulator>(man));
		}
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr void copy(const U(&src)[N], Array_t& dst, FunctionManipulator&& man) noexcept {
			this->copy<U, W, FunctionManipulator>(src, dst.begin(), math::min<u64>(N, dst.size()), std::forward<FunctionManipulator>(man));
		}

		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr ll_bool_t copy_s(const meta::ConstArray<U>& src, T* dst, const u64 size, FunctionManipulator&& man) const noexcept {
			return this->copy_s<U, W, FunctionManipulator>(src.begin(), dst, math::min<u64>(src.size(), size), std::forward<FunctionManipulator>(man));
		}
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr ll_bool_t copy_s(const meta::ConstArray<U>& src, Array_t& dst, FunctionManipulator&& man) noexcept {
			return this->copy_s<U, W, FunctionManipulator>(src.begin(), dst.begin(), math::min<u64>(src.size(), dst.size()), std::forward<FunctionManipulator>(man));
		}
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		...
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr ll_bool_t copy_s(const U(&src)[N], T* dst, const u64 size, FunctionManipulator&& man) noexcept {
			return this->copy_s<U, W, FunctionManipulator>(src, dst, math::min<u64>(N, size), std::forward<FunctionManipulator>(man));
		}
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr ll_bool_t copy_s(const U(&src)[N], Array_t& dst, FunctionManipulator&& man) noexcept {
			return this->copy_s<U, W, FunctionManipulator>(src, dst.begin(), math::min<u64>(N, dst.size()), std::forward<FunctionManipulator>(man));
		}

		#pragma endregion
		#pragma region FunctionManipulatorCreate
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void copy(const meta::ConstArray<U>& src, T* dst, const u64 size) const noexcept {
			this->copy<U, W, FunctionManipulator>(src.begin(), dst, math::min<u64>(src.size(), size));
		}
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void copy(const meta::ConstArray<U>& src, Array_t& dst) noexcept {
			this->copy<U, W, FunctionManipulator>(src.begin(), dst.begin(), math::min<u64>(src.size(), dst.size()));
		}
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		...
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr void copy(const U(&src)[N], T* dst, const u64 size) noexcept {
			this->copy<U, W, FunctionManipulator>(src, dst, math::min<u64>(N, size));
		}
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr void copy(const U(&src)[N], Array_t& dst) noexcept {
			this->copy<U, W, FunctionManipulator>(src, dst.begin(), math::min<u64>(N, dst.size()));
		}

		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr ll_bool_t copy_s(const meta::ConstArray<U>& src, T* dst, const u64 size) const noexcept {
			return this->copy_s<U, W, FunctionManipulator>(src.begin(), dst, math::min<u64>(src.size(), size));
		}
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr ll_bool_t copy_s(const meta::ConstArray<U>& src, Array_t& dst) noexcept {
			return this->copy_s<U, W, FunctionManipulator>(src.begin(), dst.begin(), math::min<u64>(src.size(), dst.size()));
		}
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		...
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr ll_bool_t copy_s(const U(&src)[N], T* dst, const u64 size) noexcept {
			return this->copy_s<U, W, FunctionManipulator>(src, dst, math::min<u64>(N, size));
		}
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr ll_bool_t copy_s(const U(&src)[N], Array_t& dst) noexcept {
			return this->copy_s<U, W, FunctionManipulator>(src, dst.begin(), math::min<u64>(N, dst.size()));
		}
		...
		template<class U = T, class W = traits::cinput<U>, CopyExtraSignature<W> COPY = meta::common::simple_set<T, W>>
		constexpr void copy(const meta::ConstArray<U>& src, T* dst, const u64 size) const noexcept {
			this->copy<U, W, COPY>(src.begin(), dst, math::min<u64>(src.size(), size));
		}
		template<class U = T, class W = traits::cinput<U>, CopyExtraSignature<W> COPY = meta::common::simple_set<T, W>>
		constexpr void copy(const meta::ConstArray<U>& src, Array_t& dst) noexcept {
			this->copy<U, W, COPY>(src.begin(), dst.begin(), math::min<u64>(src.size(), dst.size()));
		}
		template<class U = T, class W = traits::cinput<U>, CopyExtraSignature<W> COPY = meta::common::simple_set<T, W>>
		constexpr void copy(const meta::Array<U>& src, Array_t& dst) noexcept {
			this->copy<U, W, COPY>(src.begin(), dst.begin(), math::min<u64>(src.size(), dst.size()));
		...
		template<class U = T, class W = traits::cinput<U>, CopyExtraSignature<W> COPY = meta::common::simple_set<T, W>, u64 N>
		constexpr void copy(const U(&src)[N], T* dst, const u64 size) noexcept {
			this->copy<U, W, COPY>(src, dst, math::min<u64>(N, size));
		}
		template<class U = T, class W = traits::cinput<U>, CopyExtraSignature<W> COPY = meta::common::simple_set<T, W>, u64 N>
		constexpr void copy(const U(&src)[N], Array_t& dst) noexcept {
			this->copy<U, W, COPY>(src, dst.begin(), math::min<u64>(N, dst.size()));
		}

		template<class U = T, class W = traits::cinput<U>, CopyExtraSignature<W> COPY = meta::common::simple_set<T, W>>
		constexpr ll_bool_t copy_s(const meta::ConstArray<U>& src, T* dst, const u64 size) const noexcept {
			return this->copy_s<U, W, COPY>(src.begin(), dst, math::min<u64>(src.size(), size));
		}
		template<class U = T, class W = traits::cinput<U>, CopyExtraSignature<W> COPY = meta::common::simple_set<T, W>>
		constexpr ll_bool_t copy_s(const meta::ConstArray<U>& src, Array_t& dst) noexcept {
			return this->copy_s<U, W, COPY>(src.begin(), dst.begin(), math::min<u64>(src.size(), dst.size()));
		}
		template<class U = T, class W = traits::cinput<U>, CopyExtraSignature<W> COPY = meta::common::simple_set<T, W>>
		constexpr ll_bool_t copy_s(const meta::Array<U>& src, Array_t& dst) noexcept {
			return this->copy_s<U, W, COPY>(src.begin(), dst.begin(), math::min<u64>(src.size(), dst.size()));
		...
		template<class U = T, class W = traits::cinput<U>, CopyExtraSignature<W> COPY = meta::common::simple_set<T, W>, u64 N>
		constexpr ll_bool_t copy_s(const U(&src)[N], T* dst, const u64 size) noexcept {
			return this->copy_s<U, W, COPY>(src, dst, math::min<u64>(N, size));
		}
		template<class U = T, class W = traits::cinput<U>, CopyExtraSignature<W> COPY = meta::common::simple_set<T, W>, u64 N>
		constexpr ll_bool_t copy_s(const U(&src)[N], Array_t& dst) noexcept {
			return this->copy_s<U, W, COPY>(src, dst.begin(), math::min<u64>(N, dst.size()));
		}
	...
	public:
		#pragma region Baase
		template<class U = T, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void move(U* src, T* dst, u64 size, FunctionManipulator&& man) const noexcept {
		...
		template<class U = T, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void move(U* src, T* dst, u64 size) const noexcept {
			static_assert(std::is_nothrow_constructible_v<FunctionManipulator>, "FunctionManipulator needs a noexcept constructor!");
			static_assert(std::is_nothrow_destructible_v<FunctionManipulator>, "FunctionManipulator needs a noexcept destructor!");
			static_assert(std::is_copy_constructible_v<FunctionManipulator>, "FunctionManipulator needs a noexcept copy constructor!");
			static_assert(std::is_copy_assignable_v<FunctionManipulator>, "FunctionManipulator needs a noexcept copy asignable!");
			static_assert(std::is_move_constructible_v<FunctionManipulator>, "FunctionManipulator needs a noexcept move constructor!");
			static_assert(std::is_move_assignable_v<FunctionManipulator>, "FunctionManipulator needs a noexcept move asignable!");
			this->move<U, FunctionManipulator>(src.begin(), dst, math::min<u64>(src.size(), size), FunctionManipulator());
		}
		...
		template<class U = T, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void move_s(U* src, T* dst, u64 size, FunctionManipulator&& man) const noexcept {
			if (!src || !dst || size == ZERO_UI64) return llcpp::FALSE;
			this->move<U, FunctionManipulator>(src, dst, size, std::forward<FunctionManipulator>(man));
			return llcpp::TRUE;
		}
		template<class U = T, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void move_s(U* src, T* dst, u64 size) const noexcept {
			if (!src || !dst || size == ZERO_UI64) return llcpp::FALSE;
		...
		#pragma region FunctionManipulatorAsParameter
		template<class U = T, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void move(U* src, const u64 src_size, Array_t& dst, FunctionManipulator&& man) const noexcept {
			this->move<U, FunctionManipulator>(src, dst.begin(), math::min<u64>(src_size, dst.size()), std::forward<FunctionManipulator>(man));
		}
		template<class U = T, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr void move(U* src, const u64 src_size, T(&dst)[N], FunctionManipulator&& man) const noexcept {
			this->move<U, FunctionManipulator>(src, dst, math::min<u64>(src_size, N), std::forward<FunctionManipulator>(man));
		}
		template<class U = T, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void move(meta::ConstArray<U>& src, T* dst, const u64 dst_size, FunctionManipulator&& man) const noexcept {
			this->move<U, FunctionManipulator>(src, dst.begin(), math::min<u64>(src.size(), dst_size), std::forward<FunctionManipulator>(man));
		}
		template<class U = T, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr void move(U(&src)[N], T* dst, const u64 dst_size, FunctionManipulator&& man) const noexcept {
			this->move<U, FunctionManipulator>(src, dst, math::min<u64>(N, dst_size), std::forward<FunctionManipulator>(man));
		}

		template<class U = T, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr ll_bool_t move_s(U* src, const u64 src_size, Array_t& dst, FunctionManipulator&& man) const noexcept {
			return this->move_s<U, FunctionManipulator>(src, dst.begin(), math::min<u64>(src_size, dst.size()), std::forward<FunctionManipulator>(man));
		}
		template<class U = T, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr ll_bool_t move_s(U* src, const u64 src_size, T(&dst)[N], FunctionManipulator&& man) const noexcept {
			return this->move_s<U, FunctionManipulator>(src, dst, math::min<u64>(src_size, N), std::forward<FunctionManipulator>(man));
		}
		template<class U = T, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr ll_bool_t move_s(meta::ConstArray<U>& src, T* dst, const u64 dst_size, FunctionManipulator&& man) const noexcept {
			return this->move_s<U, FunctionManipulator>(src, dst.begin(), math::min<u64>(src.size(), dst_size), std::forward<FunctionManipulator>(man));
		}
		template<class U = T, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr ll_bool_t move_s(U(&src)[N], T* dst, const u64 dst_size, FunctionManipulator&& man) const noexcept {
			return this->move_s<U, FunctionManipulator>(src, dst, math::min<u64>(N, dst_size), std::forward<FunctionManipulator>(man));
		}

		#pragma endregion
		#pragma region FunctionManipulatorCreate
		template<class U = T, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void move(U* src, const u64 src_size, Array_t& dst) const noexcept {
			this->move<U, FunctionManipulator>(src, dst.begin(), math::min<u64>(src_size, dst.size()));
		}
		template<class U = T, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr void move(U* src, const u64 src_size, T(&dst)[N]) const noexcept {
			this->move<U, FunctionManipulator>(src, dst, math::min<u64>(src_size, N));
		}
		template<class U = T, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void move(meta::ConstArray<U>& src, T* dst, const u64 dst_size) const noexcept {
			this->move<U, FunctionManipulator>(src, dst.begin(), math::min<u64>(src.size(), dst_size));
		}
		template<class U = T, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr void move(U(&src)[N], T* dst, const u64 dst_size) const noexcept {
			this->move<U, FunctionManipulator>(src, dst, math::min<u64>(N, dst_size));
		}

		template<class U = T, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr ll_bool_t move_s(U* src, const u64 src_size, Array_t& dst) const noexcept {
			return this->move_s<U, FunctionManipulator>(src, dst.begin(), math::min<u64>(src_size, dst.size()));
		}
		template<class U = T, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr ll_bool_t move_s(U* src, const u64 src_size, T(&dst)[N]) const noexcept {
			return this->move_s<U, FunctionManipulator>(src, dst, math::min<u64>(src_size, N));
		}
		template<class U = T, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr ll_bool_t move_s(meta::ConstArray<U>& src, T* dst, const u64 dst_size) const noexcept {
			return this->move_s<U, FunctionManipulator>(src, dst.begin(), math::min<u64>(src.size(), dst_size));
		}
		template<class U = T, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr ll_bool_t move_s(U(&src)[N], T* dst, const u64 dst_size) const noexcept {
			return this->move_s<U, FunctionManipulator>(src, dst, math::min<u64>(N, dst_size));
		}
		...
		template<class U = T, MoveExtraSignature<U> MOVE = meta::common::simple_move<T, U>>
		constexpr void move(U* src, const u64 src_size, Array_t& dst) const noexcept {
			this->move<U, MOVE>(src, dst.begin(), math::min<u64>(src_size, dst.size()));
		}
		template<class U = T, MoveExtraSignature<U> MOVE = meta::common::simple_move<T, U>, u64 N>
		constexpr void move(U* src, const u64 src_size, T(&dst)[N]) const noexcept {
			this->move<U, MOVE>(src, dst, math::min<u64>(src_size, N));
		}
		template<class U = T, MoveExtraSignature<U> MOVE = meta::common::simple_move<T, U>>
		constexpr void move(meta::ConstArray<U>& src, T* dst, const u64 dst_size) const noexcept {
			this->move<U, MOVE>(src, dst.begin(), math::min<u64>(src.size(), dst_size));
		}
		template<class U = T, MoveExtraSignature<U> MOVE = meta::common::simple_move<T, U>, u64 N>
		constexpr void move(U(&src)[N], T* dst, const u64 dst_size) const noexcept {
			this->move<U, MOVE>(src, dst, math::min<u64>(N, dst_size));
		}

		template<class U = T, MoveExtraSignature<U> MOVE = meta::common::simple_move<T, U>>
		constexpr ll_bool_t move_s(U* src, const u64 src_size, Array_t& dst) const noexcept {
			return this->move_s<U, MOVE>(src, dst.begin(), math::min<u64>(src_size, dst.size()));
		}
		template<class U = T, MoveExtraSignature<U> MOVE = meta::common::simple_move<T, U>, u64 N>
		constexpr ll_bool_t move_s(U* src, const u64 src_size, T(&dst)[N]) const noexcept {
			return this->move_s<U, MOVE>(src, dst, math::min<u64>(src_size, N));
		}
		template<class U = T, MoveExtraSignature<U> MOVE = meta::common::simple_move<T, U>>
		constexpr ll_bool_t move_s(meta::ConstArray<U>& src, T* dst, const u64 dst_size) const noexcept {
			return this->move_s<U, MOVE>(src, dst.begin(), math::min<u64>(src.size(), dst_size));
		}
		template<class U = T, MoveExtraSignature<U> MOVE = meta::common::simple_move<T, U>, u64 N>
		constexpr ll_bool_t move_s(U(&src)[N], T* dst, const u64 dst_size) const noexcept {
			return this->move_s<U, MOVE>(src, dst, math::min<u64>(N, dst_size));
		}
	...
	public:
		#pragma region Base
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void shiftLeft(T* _array, T* last, const u64 first, const u64 num, W null, FunctionManipulator&& man) const noexcept {
			using CopyFunction = void(FunctionManipulator::*)(T&, W) const noexcept;
			static_assert(traits::common::has_copy_function_v<FunctionManipulator, CopyFunction>,
				"FunctionManipulator::copy() const noexcept is required!");
		...
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void shiftLeft(T* _array, T* last, const u64 first, const u64 num, W null) const noexcept {
			static_assert(std::is_nothrow_constructible_v<FunctionManipulator>, "FunctionManipulator needs a noexcept constructor!");
			static_assert(std::is_nothrow_destructible_v<FunctionManipulator>, "FunctionManipulator needs a noexcept destructor!");
			static_assert(std::is_copy_constructible_v<FunctionManipulator>, "FunctionManipulator needs a noexcept copy constructor!");
			static_assert(std::is_copy_assignable_v<FunctionManipulator>, "FunctionManipulator needs a noexcept copy asignable!");
		...
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr ll_bool_t shiftLeft_s(T* _array, T* last, const u64 first, const u64 num, W null, FunctionManipulator&& man) const noexcept {
		...
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr ll_bool_t shiftLeft_s(T* _array, T* last, const u64 first, const u64 num, W null) const noexcept {
			if (_array > last) return llcpp::FALSE;
			if (num != ZERO_UI64) return llcpp::FALSE;
			if (num > first) first = num;
		...
		#pragma region FunctionManipulatorAsParameter
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void shiftLeft(Array_t& _array, const u64 first, const u64 num, W null, FunctionManipulator&& man) const noexcept {
			this->shiftLeft<U, W, FunctionManipulator>(_array.begin(), _array.end(), first, num, null, std::forward<FunctionManipulator>(man));
		}
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr void shiftLeft(T(&_array)[N], const u64 first, const u64 num, W null, FunctionManipulator&& man) const noexcept {
			this->shiftLeft<U, W, FunctionManipulator>(_array, _array + N, first, num, null, std::forward<FunctionManipulator>(man));
		}

		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr ll_bool_t shiftLeft_s(Array_t& _array, const u64 first, const u64 num, W null, FunctionManipulator&& man) const noexcept {
		...
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr ll_bool_t shiftLeft_s(T(&_array)[N], const u64 first, const u64 num, W null, FunctionManipulator&& man) const noexcept {
		...
		#pragma region FunctionManipulatorCreate
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void shiftLeft(Array_t& _array, const u64 first, const u64 num, W null) const noexcept {
			this->shiftLeft<U, W, FunctionManipulator>(_array.begin(), _array.end(), first, num, null);
		}
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr void shiftLeft(T(&_array)[N], const u64 first, const u64 num, W null) const noexcept {
			this->shiftLeft<U, W, FunctionManipulator>(_array, _array + N, first, num, null);
		}

		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr ll_bool_t shiftLeft_s(Array_t& _array, const u64 first, const u64 num, W null) const noexcept {
			return this->shiftLeft_s<U, W, FunctionManipulator>(_array.begin(), _array.end(), first, num, null);
		}
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr ll_bool_t shiftLeft_s(T(&_array)[N], const u64 first, const u64 num, W null) const noexcept {
	...
	public:
		#pragma region Base
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void shiftRight(T* _array, T* last, const u64 first, const u64 num, W null, FunctionManipulator&& man) const noexcept {
			using CopyFunction = void(FunctionManipulator::*)(T&, W) const noexcept;
			static_assert(traits::common::has_copy_function_v<FunctionManipulator, CopyFunction>,
				"FunctionManipulator::copy() const noexcept is required!");
		...
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void shiftRight(T* _array, T* last, const u64 first, const u64 num, W null) const noexcept {
			static_assert(std::is_nothrow_constructible_v<FunctionManipulator>, "FunctionManipulator needs a noexcept constructor!");
			static_assert(std::is_nothrow_destructible_v<FunctionManipulator>, "FunctionManipulator needs a noexcept destructor!");
			static_assert(std::is_copy_constructible_v<FunctionManipulator>, "FunctionManipulator needs a noexcept copy constructor!");
			static_assert(std::is_copy_assignable_v<FunctionManipulator>, "FunctionManipulator needs a noexcept copy asignable!");
		...
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr ll_bool_t shiftRight_s(T* _array, T* last, const u64 first, const u64 num, W null, FunctionManipulator&& man) const noexcept {
			if (_array > last) return llcpp::FALSE;
			if (num != ZERO_UI64) return llcpp::FALSE;
		...
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr ll_bool_t shiftRight_s(T* _array, T* last, const u64 first, const u64 num, W null) const noexcept {
			if (_array > last) return llcpp::FALSE;
			if (num != ZERO_UI64) return llcpp::FALSE;
		...
		#pragma region FunctionManipulatorAsParameter
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void shiftRight(Array_t& _array, const u64 first, const u64 num, W null, FunctionManipulator&& man) const noexcept {
			this->shiftRight<U, W, FunctionManipulator>(_array.begin(), _array.end(), first, num, null, std::forward<FunctionManipulator>(man));
		}
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr void shiftRight(T(&_array)[N], const u64 first, const u64 num, W null, FunctionManipulator&& man) const noexcept {
			this->shiftRight<U, W, FunctionManipulator>(_array, _array + N, first, num, null, std::forward<FunctionManipulator>(man));
		}

		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr ll_bool_t shiftRight_s(Array_t& _array, const u64 first, const u64 num, W null, FunctionManipulator&& man) const noexcept {
		...
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr ll_bool_t shiftRight_s(T(&_array)[N], const u64 first, const u64 num, W null, FunctionManipulator&& man) const noexcept {
		...
		#pragma region FunctionManipulatorCreate
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr void shiftRight(Array_t& _array, const u64 first, const u64 num, W null) const noexcept {
			this->shiftRight<U, W, FunctionManipulator>(_array.begin(), _array.end(), first, num, null);
		}
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr void shiftRight(T(&_array)[N], const u64 first, const u64 num, W null) const noexcept {
			this->shiftRight<U, W, FunctionManipulator>(_array, _array + N, first, num, null);
		}

		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>>
		constexpr ll_bool_t shiftRight_s(Array_t& _array, const u64 first, const u64 num, W null) const noexcept {
			return this->shiftRight_s<U, W, FunctionManipulator>(_array.begin(), _array.end(), first, num, null);
		}
		template<class U = T, class W = traits::cinput<U>, class FunctionManipulator = algorithm::__algorithm__::ManipulatorDefault<T, U>, u64 N>
		constexpr ll_bool_t shiftRight_s(T(&_array)[N], const u64 first, const u64 num, W null) const noexcept {
	...
	//}
	//template<class T, class U = traits::template_types<T>, u64 N>
